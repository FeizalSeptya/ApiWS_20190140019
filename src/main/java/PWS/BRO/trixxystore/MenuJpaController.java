...
import PWS.BRO.trixxystore.exceptions.NonexistentEntityException;
import PWS.BRO.trixxystore.exceptions.PreexistingEntityException;
...
public class MenuJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("PWS.BRO_trixxystore_jar_0.0.1-SNAPSHOTPU");
